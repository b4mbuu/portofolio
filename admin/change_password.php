			...
			if(!strlen($new_password)<8 || preg_match('@[0-9]@', $new_password) || preg_match('@[a-z]@', $new_password) || preg_match('@[A-Z]@', $new_password)){
				...
				if($new_password==$con_password){
					...
					$new_pass_update = $dbcon -> query("UPDATE users SET password = '$new_hash_password' WHERE email='$email'");
						$password_change_success = "Таны нууц үг амжилттай өөрчлөгдсөн";
		

				}else{
					// if new and con pass not match
					$con_pass_not_match = "Нууц үг шинэ нууц үгтэй таарахгүй байгааг баталгаажуулна уу";
				}
			}else{
				// if pass not valid
				$pass_lenght = "Тоо, Том, Жижиг үсгээр 8 урттай шинэ нууц үг оруулна уу";
			}
		}else{
			// if new and old pass match
			$old_new_matched = "Та хуучин нууц үгээ шинэ нууц үг болгон тохируулах боломжгүй";
		}


	}else{
		// if old password not match
		$old_pass_not_match = "Хуучин нууц үг таарахгүй байна";
	}
}
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-6 m-auto">
                                <div class="card-box">
                                    <h4 class="header-title mb-4">Бүртгэл Хянах</h4>
                                    ...
                                    <form action="" method="post">
																			...
																			<div class="form-group">
																				<label for="con_pass">Нууц үгээ баталгаажуулна уу</label>
