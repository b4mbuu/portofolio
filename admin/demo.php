                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="about_me_main.php">
                                    <i class="far fa-address-card"></i>  <span> Миний тухай </span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="contact_information.php">
                                    <i class="fas fa-envelope-square"></i> <span> Холбоо барих мэдээлэл</span>
                                </a>
                            </li>
                             ...
                             <li>
                                <a href="all_testimonials.php">
                                    ...
                                    <span> сэтгэгдэлүүд</span>
                                </a>
                            </li>

                             <li>
                                <a href="statistics.php">
                                    <i class="fas fa-print"></i><span> Статистик</span>
                                </a>
                            </li>
                             ...
                             <li>
                                <a href="best_works.php">
                                    ...
                                    <span> Миний шилдэг бүтээлүүд</span>
                                </a>
                            </li>
                ...
                <div class="topbar">
                    ...
                    <nav class="navbar-custom">
                        ...
                        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                            ...
                            <li>
                                <h4 class="page-title-main">Хяналтын самбар</h4>
                                <ol class="breadcrumb">
