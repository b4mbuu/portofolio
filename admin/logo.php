...
?>
						...
						<!-- card start -->
          	<div class="card mb-3">
						  <div class="card-header text-center bg-success"> <h2>Бүх Лого</h2></div>
						  ...
						  <!-- logo add message alert  -->
										...
										<?php foreach ($all_logo as $result) {
										 ...
										 ?>
											...
											<tr>
												...
												<td>
														<a class="btn btn-sm btn-danger" href="logo_delete.php?id=<?=base64_encode($result['id'])?>">Устгах</a>
												</td>
											</tr>
								...
								<a class="btn btn-block btn-success" href="add_logo.php">Лого Нэмэх</a>
