...
?>
	<div class="card text-dark mb-3" >
	  <div class="card-header bg-success text-center display-4">Үйлчилгээг шинэчлэх</div>
	  	<div class="card-body">

						<form action="" method="post" >

							<div class="form-group">
								<label for="project_name">Үйлчилгээний icon</label>
								<input type="text" class="form-control" name="icon" value="<?=$service_data['icon']?>">
							</div>

							<div class="form-group">
								<label for="project_name">Үйлчилгээний нэр</label>
