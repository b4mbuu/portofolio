...
<!-- Start Page content -->
	<div class="card text-dark mb-3" >
		<div class="card-header bg-success text-center"><h2>Сэтгэгдэл Нэмэх </h2></div>
			<div class="card-body">
					...
					<form action="" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							<input class="btn btn-block btn-success" type="submit" value="Сэтгэгдэл Нэмэх" name="submit">
						</div>
