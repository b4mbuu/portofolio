...
$title="Боловсролын мэдээлэл нэмнэ үү";
...
<!-- Start Page content -->
 	<div class="card text-dark mb-3" >
	  <div class="card-header bg-success text-center "><h2>Зэрэг нэмэх</h2></div>
	  <div class="card-body">

			<form action="" method="post" >
				<div class="form-group">
					<label for="project_name">Зэрэглэлийн нэр</label>
					<input type="text" class="form-control" name="degree_name">
				</div>

				<div class="form-group">
					<label for="project_catagory">Жил</label>
					<input type="text" class="form-control" name="year">
				</div>

				<div class="form-group">
					<label for="project_catagory">Прогресс самбар</label>
				...
				<div class="form-group">
					<input class="btn btn-block btn-success" type="submit" value="Нэмэх" name="submit">
				</div>
