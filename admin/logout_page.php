    ...
    <body class="account-pages">
        ...
        <div class="wrapper-page account-page-full">
                    ...
                    <div class="account-box">
                        ...
                        <div class="card-box p-5">
                            ...
                            <div class="text-center m-b-20">
                                ...
                                <h4>Дараа Дахин уулзая!</h4>

                                <p class="text-muted font-14 m-t-10"> Та одоо амжилттай гарлаа.Нүүр луу буцах<a href="../login.php" class="text-dark m-r-5"><b>Sign In</b></a></p>
                            </div>
            ...
            <div class="m-t-40 text-center">
                <p class="account-copyright">2025 © Duurenjargal.9911</p>
            </div>
