                 ...
                 ?>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="index.php">
                                    <i class="fi-air-play"></i> <span> Хяналтын самбар</span>
                                </a>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li><a href="about_me.php">Миний тухай Шинэчлэлт</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="services.php">Үйлчилгээ</a></li>
                                    <li><a href="service_add.php">Үйлчилгээ нэмэх</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="fas fa-comments"></i>
                                    ...
                                    <span> Сэтгэгдэл</span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="all_testimonials.php">Сэтгэгдэл</a></li>
                                    <li><a href="testimonials.php">Сэтгэгдэл Нэмэх</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li><a href="statistics_edit.php">Статистик шинэчлэх</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="fi-air-play"></i>
                                    ...
                                    <span> Миний шилдэг бүтээлүүд</span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="best_works.php">Миний шилдэг бүтээлүүд</a></li>
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="fas fa-lightbulb"></i>
                                    ...
                                    <span> Лого</span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="logo.php">Лого</a></li>
                                    <li><a href="add_logo.php">Лого Нэмэх</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="dropdown notification-list">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated profile-dropdown">
                                    ...
                                    <a href="profile.php" class="dropdown-item notify-item">
                                        <i class="fi-head"></i> <span>Миний хаяг</span>
                                    </a>
                        ...
                        <ul class="list-inline menu-left mb-0">
                            ...
                            <li>
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="index.php">Хяналтын самбар</a></li>
