		...
		if($_FILES['photo']['size']<5000000){
			...
			if( in_array(strtolower($photo_ext),$accepted_extension_list) ){
				...
				if($update_photo){
					...
					$_SESSION['testimonial_photo_success'] = "Зургийг амжилттай хавсаргав!";
				...
				$_SESSION['testimonial_photo_extension'] = "jpg,png эсвэл jpeg зураг хавсаргана уу";
				header('location: testimonial_update.php?id=' . base64_encode($id));
				ob_end_flush();
			}
			...
			$_SESSION['testimonial_photo_size'] = "1MB-аас бага хэмжээтэй зураг хавсаргав";
			header('location: testimonial_update.php?id=' . base64_encode($id));
			ob_end_flush();
		}
