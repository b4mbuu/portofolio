    ...
    <div class="row">
                                    ...
                                    <div class="row text-dark">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="media-body text-white">
                                                ...
                                                <p class="font-13">ХЭРЭГЛЭГЧИЙН И-мэйл: <?=$row['email']?></p>
                                                <p class="mb-0">БАЙДАЛ: идэвхтэй <i class="fa fa-circle text-success"></i></p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="text-right">
                                                <a type="button" href="profile.php" class="btn btn-light waves-effect">
                                                    <i class="mdi mdi-account-settings mr-1"></i> Профайлыг засах
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                ...
                                <div class="card-box">
                                    <span class="bg-success p-1 text-white mb-1">Нүүр хэсэг</span>
                                    ...
                                    <br>
                                    <a class="btn btn-sm btn-block btn-success" href="about_me.php">Засварлах</a>
                                </div>
                                <!-- Personal-Information -->
                              </div>
                            ...
                            <div class="col-xl-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <a class="btn btn-sm btn-block btn-success" href="users.php">бүх хэрэглэгчид</a>
                                    </div><!-- end col -->

                                    <div class="col-sm-4">
                                        <div class="card-box tilebox-one">
                                            <i class="dripicons-phone  float-right text-muted"></i>
                                            <h6 class="text-muted text-uppercase mt-0">Үйлчилгээ</h6>
                                        ...
                                        <a class="btn btn-sm btn-block btn-success" href="services.php">бүх үйлчилгээ</a>
                                    </div><!-- end col -->

                                    <div class="col-sm-4">
                                        <div class="card-box tilebox-one">
                                            <i class="dripicons-message  float-right text-muted"></i>
                                            <h6 class="text-muted text-uppercase mt-0">Сэтгэгдэл</h6>
                                            <h2 class="" data-plugin="counterup">
                                              <?php
                                        ...
                                        <a class="btn btn-sm btn-block btn-success" href="all_guest_message.php">Сэтгэгдэлүүд</a>
                                    </div><!-- end col -->
                                ...
                                <div class="card-box">
                                    <h4 class="header-title mb-3">Миний төсөлүүд</h4>
                                    ...
                                    <table id="example" class="table table-bordered text-center">
                                          ...
                                          <?php foreach ($all_works as $result) {
                                           ...
                                           ?>
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                <div class="btn-group">
                                                  <a class="btn btn-sm btn-warning" href="best_works_update.php?id=<?=base64_encode($result['id'])?>">Шинэчлэх</a>
                                        ...
                                        <a class="btn btn-block btn-success mt-2" href="best_works.php">Бүгдийг харах</a>
