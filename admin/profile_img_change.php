...
if(isset($_POST['photo_submit'])){
	...
	if(!empty($photo)){
		...
		if($_FILES['photo']['size']<2000000){
			...
			if( in_array(strtolower($photo_ext),$accepted_extension_list) ){
				...
				if($update_photo){
					...
					$_SESSION['profile_photo_success'] = "Зургийг амжилттай хавсаргав!";
				...
				$_SESSION['profile_photo_extension'] = "jpg,png эсвэл jpeg зураг хавсаргана уу";
				header('location: profile.php');
				ob_end_flush();
			}
			...
			$_SESSION['profile_photo_size'] = "1MB-аас бага хэмжээтэй зураг хавсаргав";
			header('location: profile.php');
			ob_end_flush();
		}
		...
		// if empty
		$_SESSION['profile_photo_emty'] = "Зураг хавсаргав";
		header('location: profile.php');
		ob_end_flush();
	}
