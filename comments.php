...
$DATABASE_USER = 'root';
$DATABASE_PASS = '';
$DATABASE_NAME = 'personal_portfolio';
try {
...
function show_write_comment_form($parent_id = -1) {
    ...
    <div class="write_comment" data-comment-id="' . $parent_id . '">
        <form>
            ...
            <input name="name" type="text" placeholder="Таны Нэр" required>
            <textarea name="content" placeholder="Сэтгэгдлээ энд бичнэ үү" required></textarea>
            <button type="submit">Сэтгэгдэл Нэмэх</button>
        </form>
    </div>
    ';
    return $html;
...
<div class="comment_header">
    <span class="total"><?=$comments_info['total_comments']?> Сэтгэгдэл</span>
    <a href="#" class="write_comment_btn" data-comment-id="-1">Сэтгэгдэл бичих</a>
</div>
