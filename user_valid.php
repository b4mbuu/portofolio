...
if(empty($fname)){
	$input_error['name'] = "Нэрээ оруулна уу";
}

else if(preg_match('@[0-9]@', $fname)){
	$input_error['name'] = "Тоо оруулахгүй нэр оруулна уу";
}
if(empty($email)){
	$input_error['email']="Имэйл хаяг оруулна уу";
}
else if(!filter_var($email,FILTER_VALIDATE_EMAIL)){
	$input_error['email'] = "Хүчинтэй имэйл оруулна уу";
}
if(empty($password)){
	$input_error['password'] = '8-С Дээш нууц үсгийн тоо, том, жижиг үсгээр оруулна';
}
	...
	$input_error['cpassword'] = "Баталгаажуулах нууц үгийг оруулна уу";
}
